...
*/
    ...
    XLOOKUP: {
        //(0,1) (1,1) (-1,1) (2,1) (0,-1) (-1,-1) (1,-1) (2,-1) (0,2)
        //'XLOOKUP(A2, A1:A9, B1:B9)': .69,
        //match_mode = 0 and searc_mode is 1
        'XLOOKUP(A2, A1:A9, B1:B9)': .69,
        ...
        //match_mode = 1 and searc_mode is -1 specific
        //basic duplicate
        'XLOOKUP(A2, A1:A9, B1:B9,,1,-1)': .69,
        'XLOOKUP("Bananas", A1:A9, B1:B9,,1,-1)': 0.34,
        'XLOOKUP(0.55, B1:B9, C1:C9,,1,-1)': 15,
        ...
        'XLOOKUP("d", {"a","c","e","g","i","k","m","p"}, {8,7,6,5,4,3,2,1},  10, 1, -2)': 3,
        'XLOOKUP("b", {"a","c","e","g","i","k","m","p"}, {8,7,6,5,4,3,2,1},  10, 1, -2)': 2,
        'XLOOKUP("n", {"a","c","e","g","i","k","m","p"}, {8,7,6,5,4,3,2,1},  10, 1, -2)': 8,
        'XLOOKUP("f", {"a","c","e","g","i","k","m","p"}, {8,7,6,5,4,3,2,1},  10, 1, -2)': 4,
        'XLOOKUP("j", {"a","c","e","g","i","k","m","p"}, {8,7,6,5,4,3,2,1},  10, 1, -2)': 6,
        'XLOOKUP(-1.5, {8,7,6,5,4,3,2,1},{"h", "g", "f", "e", "d", "c", "b", "a"}, 10, 1, -2)': 'a',
        'XLOOKUP(1.5, {8,7,6,5,4,3,2,1},{"h", "g", "f", "e", "d", "c", "b", "a"}, 10, 1, -2)': 'b',
        'XLOOKUP(7.5, {8,7,6,5,4,3,2,1},{"h", "g", "f", "e", "d", "c", "b", "a"}, 10, 1, -2)': 'h',
        'XLOOKUP(8.5, {8,7,6,5,4,3,2,1},{"h", "g", "f", "e", "d", "c", "b", "a"}, 10, 1, -2)': 10,
