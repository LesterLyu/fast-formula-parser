...
module.exports = {
    ...
    FILTER: {
        ...
        'SUM(FILTER(B2:B10,{TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE}))' : 11.77,
        'FILTER(B2:B10,{FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE},10)': 10,
        ...
        'SUM(FILTER(B2:C7,D2:D7=5))': 173.22,
        'SUM(FILTER(B2:B10,D1:D9=5))': 11.08,
        'SUM(FILTER(B2:C10,D1:D9=5))': 187.08,
        'SUM(FILTER(E1:E9,D1:D9=5))': 48,
        'SUM(FILTER(E1:E9,D4:D12=5))': 41
